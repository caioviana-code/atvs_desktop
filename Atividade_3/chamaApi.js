...
function editarUsuario(idUsuario) {
    axios.get(`http://infopguaifpr.com.br:3052/pegarUsuarioPeloId/${idUsuario}`)
        .then(response => {
            ...
            document.querySelector('#disciplina').value = usuario.disciplina;

            // Mostra a modal de edição
...
function atualizarUsuario(idUsuario, nome, email, disciplina) {
    ...
    axios.put(`http://infopguaifpr.com.br:3052/atualizarUsuario`, usuario)
        .then(response => {
...
document.querySelector('#btnEditarUsuario').addEventListener('click', function () {
    ...
    atualizarUsuario(idUsuario, nome, email, disciplina);
});